...
func RegisterRunnerServiceHandler(s *mcpserver.MCPServer, srv RunnerServiceServer, opts ...runtime.Option) {
	...
	s.AddTool(CreateSessionTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		var req v2.CreateSessionRequest
	...
	s.AddTool(DeleteSessionTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		var req v2.DeleteSessionRequest
	...
	s.AddTool(ListSessionsTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		var req v2.ListSessionsRequest
	...
	s.AddTool(ResolveProgramTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		var req v2.ResolveProgramRequest
	...
	UpdateSessionTool := RunnerService_UpdateSessionTool
	// Add extra properties to schema if configured
	if len(config.ExtraProperties) > 0 {
		UpdateSessionTool = runtime.AddExtraPropertiesToTool(UpdateSessionTool, config.ExtraProperties)
	}

	s.AddTool(UpdateSessionTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		var req v2.UpdateSessionRequest
		...
		resp, err := srv.UpdateSession(ctx, &req)
		if err != nil {
			return runtime.HandleError(err)
		}
...
func RegisterRunnerServiceHandlerOpenAI(s *mcpserver.MCPServer, srv RunnerServiceServer, opts ...runtime.Option) {
	...
	UpdateSessionToolOpenAI := RunnerService_UpdateSessionToolOpenAI
	// Add extra properties to schema if configured
	if len(config.ExtraProperties) > 0 {
		UpdateSessionToolOpenAI = runtime.AddExtraPropertiesToTool(UpdateSessionToolOpenAI, config.ExtraProperties)
	}

	s.AddTool(UpdateSessionToolOpenAI, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		var req v2.UpdateSessionRequest
...
type RunnerServiceClient interface {
	CreateSession(ctx context.Context, req *v2.CreateSessionRequest, opts ...grpc.CallOption) (*v2.CreateSessionResponse, error)
	DeleteSession(ctx context.Context, req *v2.DeleteSessionRequest, opts ...grpc.CallOption) (*v2.DeleteSessionResponse, error)
	GetSession(ctx context.Context, req *v2.GetSessionRequest, opts ...grpc.CallOption) (*v2.GetSessionResponse, error)
	ListSessions(ctx context.Context, req *v2.ListSessionsRequest, opts ...grpc.CallOption) (*v2.ListSessionsResponse, error)
	ResolveProgram(ctx context.Context, req *v2.ResolveProgramRequest, opts ...grpc.CallOption) (*v2.ResolveProgramResponse, error)
	UpdateSession(ctx context.Context, req *v2.UpdateSessionRequest, opts ...grpc.CallOption) (*v2.UpdateSessionResponse, error)
}
...
type ConnectRunnerServiceClient interface {
	CreateSession(ctx context.Context, req *connect.Request[v2.CreateSessionRequest]) (*connect.Response[v2.CreateSessionResponse], error)
	DeleteSession(ctx context.Context, req *connect.Request[v2.DeleteSessionRequest]) (*connect.Response[v2.DeleteSessionResponse], error)
	GetSession(ctx context.Context, req *connect.Request[v2.GetSessionRequest]) (*connect.Response[v2.GetSessionResponse], error)
	ListSessions(ctx context.Context, req *connect.Request[v2.ListSessionsRequest]) (*connect.Response[v2.ListSessionsResponse], error)
	ResolveProgram(ctx context.Context, req *connect.Request[v2.ResolveProgramRequest]) (*connect.Response[v2.ResolveProgramResponse], error)
	UpdateSession(ctx context.Context, req *connect.Request[v2.UpdateSessionRequest]) (*connect.Response[v2.UpdateSessionResponse], error)
}
...
func ForwardToConnectRunnerServiceClient(s *mcpserver.MCPServer, client ConnectRunnerServiceClient, opts ...runtime.Option) {
	...
	s.AddTool(UpdateSessionTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		resp, err := client.UpdateSession(ctx, connect.NewRequest(&req))
		if err != nil {
			return runtime.HandleError(err)
		}
