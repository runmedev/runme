...
class ExecuteResponse$Type extends MessageType {
    constructor() {
        super("runme.runner.v2.ExecuteResponse", [
            ...
            { no: 7, name: "pwd", kind: "message", T: () => ExecuteResponse_Pwd }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string mime_type */ 5:
                    ...
                    break;
                case /* runme.runner.v2.ExecuteResponse.Pwd pwd */ 7:
                    message.pwd = ExecuteResponse_Pwd.internalBinaryRead(reader, reader.uint32(), options, message.pwd);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* runme.runner.v2.ExecuteResponse.Pwd pwd = 7; */
        if (message.pwd)
            ExecuteResponse_Pwd.internalBinaryWrite(message.pwd, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class ExecuteResponse_Pwd$Type extends MessageType {
    constructor() {
        super("runme.runner.v2.ExecuteResponse.Pwd", [
            { no: 1, name: "current", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "previous", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* string previous = 2; */
        if (message.previous !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.previous);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const ExecuteResponse_Pwd = new ExecuteResponse_Pwd$Type();
// @generated message type with reflection information, may provide speed optimized methods
