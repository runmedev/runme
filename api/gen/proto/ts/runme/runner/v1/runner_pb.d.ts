...
export interface ExecuteRequest {
     ...
     *
     * @generated from protobuf field: string run_id = 29
     */
    runId: string;
}
/**
...
export interface ResolveProgramRequest {
     ...
     *
     * @generated from protobuf field: runme.runner.v1.ResolveProgramRequest.Retention retention = 9
     */
...
export interface MonitorEnvStoreRequest {
    ...
    session?: Session;
    /**
     * @generated from protobuf field: runme.runner.v1.MonitorEnvStoreRequest.SnapshotPolicy snapshot_policy = 2
     */
    snapshotPolicy?: MonitorEnvStoreRequest_SnapshotPolicy;
}
/**
 * @generated from protobuf message runme.runner.v1.MonitorEnvStoreRequest.SnapshotPolicy
 */
...
declare class ProcessPID$Type extends MessageType<ProcessPID> {
    constructor();
    create(value?: PartialMessage<ProcessPID>): ProcessPID;
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ProcessPID): ProcessPID;
    internalBinaryWrite(message: ProcessPID, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
/**
 * @generated MessageType for protobuf message runme.runner.v1.MonitorEnvStoreRequest.SnapshotPolicy
 */
