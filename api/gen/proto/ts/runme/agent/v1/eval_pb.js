...
// @generated from protobuf file "runme/agent/v1/eval.proto" (package "runme.agent.v1", syntax proto3)
// tslint:disable
// @ts-nocheck
 ...
 *
 * @generated from protobuf enum runme.agent.v1.Assertion.Type
 */
 ...
 *
 * @generated from protobuf enum runme.agent.v1.Assertion.Result
 */
...
class Assertion$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.Assertion", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "buf.validate.field": { required: true, string: { minLen: "1" } } } },
            { no: 2, name: "type", kind: "enum", T: () => ["runme.agent.v1.Assertion.Type", Assertion_Type, "TYPE_"], options: { "buf.validate.field": { required: true } } },
            { no: 3, name: "result", kind: "enum", T: () => ["runme.agent.v1.Assertion.Result", Assertion_Result, "RESULT_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string name */ 1:
                    ...
                    break;
                case /* runme.agent.v1.Assertion.Type type */ 2:
                    message.type = reader.int32();
                    break;
                case /* runme.agent.v1.Assertion.Result result */ 3:
                    message.result = reader.int32();
                    break;
                case /* runme.agent.v1.Assertion.ShellRequiredFlag shell_required_flag */ 4:
                    message.payload = {
                    ...
                    break;
                case /* runme.agent.v1.Assertion.ToolInvocation tool_invocation */ 5:
                    message.payload = {
                    ...
                    break;
                case /* runme.agent.v1.Assertion.FileRetrieval file_retrieval */ 6:
                    message.payload = {
                    ...
                    break;
                case /* runme.agent.v1.Assertion.LLMJudge llm_judge */ 7:
                    message.payload = {
                        oneofKind: "llmJudge",
                        llmJudge: Assertion_LLMJudge.internalBinaryRead(reader, reader.uint32(), options, message.payload.llmJudge)
                    };
                    break;
                case /* runme.agent.v1.Assertion.CodeblockRegex codeblock_regex */ 8:
                    message.payload = {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* runme.agent.v1.Assertion.Type type = 2; */
        if (message.type !== 0)
            writer.tag(2, WireType.Varint).int32(message.type);
        /* runme.agent.v1.Assertion.Result result = 3; */
        if (message.result !== 0)
            writer.tag(3, WireType.Varint).int32(message.result);
        /* runme.agent.v1.Assertion.ShellRequiredFlag shell_required_flag = 4; */
        ...
        /* runme.agent.v1.Assertion.ToolInvocation tool_invocation = 5; */
        ...
        /* runme.agent.v1.Assertion.FileRetrieval file_retrieval = 6; */
        ...
        /* runme.agent.v1.Assertion.LLMJudge llm_judge = 7; */
        ...
        /* runme.agent.v1.Assertion.CodeblockRegex codeblock_regex = 8; */
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.Assertion
 */
export const Assertion = new Assertion$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Assertion_ShellRequiredFlag$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.Assertion.ShellRequiredFlag", [
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.Assertion.ShellRequiredFlag
 */
...
class Assertion_ToolInvocation$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.Assertion.ToolInvocation", [
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.Assertion.ToolInvocation
 */
...
class Assertion_FileRetrieval$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.Assertion.FileRetrieval", [
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.Assertion.FileRetrieval
 */
export const Assertion_FileRetrieval = new Assertion_FileRetrieval$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Assertion_LLMJudge$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.Assertion.LLMJudge", [
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.Assertion.LLMJudge
 */
export const Assertion_LLMJudge = new Assertion_LLMJudge$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Assertion_CodeblockRegex$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.Assertion.CodeblockRegex", [
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.Assertion.CodeblockRegex
 */
export const Assertion_CodeblockRegex = new Assertion_CodeblockRegex$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EvalSample$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.EvalSample", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string kind */ 1:
                    ...
                    break;
                case /* runme.agent.v1.ObjectMeta metadata */ 2:
                ...
                case /* string input_text */ 3:
                    ...
                    break;
                case /* repeated runme.agent.v1.Assertion assertions */ 4:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* runme.agent.v1.ObjectMeta metadata = 2; */
        if (message.metadata)
        ...
        /* repeated runme.agent.v1.Assertion assertions = 4; */
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.EvalSample
 */
export const EvalSample = new EvalSample$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EvalDataset$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.EvalDataset", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated runme.agent.v1.EvalSample samples */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* repeated runme.agent.v1.EvalSample samples = 1; */
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.EvalDataset
 */
export const EvalDataset = new EvalDataset$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ObjectMeta$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.ObjectMeta", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "buf.validate.field": { required: true, string: { minLen: "1" } } } }
        ]);
    }
    create(value) {
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.ObjectMeta
 */
export const ObjectMeta = new ObjectMeta$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ExperimentSpec$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.ExperimentSpec", [
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.ExperimentSpec
 */
export const ExperimentSpec = new ExperimentSpec$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Experiment$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.Experiment", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string kind */ 2:
                    message.kind = reader.string();
                    break;
                case /* runme.agent.v1.ObjectMeta metadata */ 3:
                    message.metadata = ObjectMeta.internalBinaryRead(reader, reader.uint32(), options, message.metadata);
                    break;
                case /* runme.agent.v1.ExperimentSpec spec */ 4:
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.Experiment
 */
