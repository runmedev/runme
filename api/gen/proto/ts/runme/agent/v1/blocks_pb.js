...
// @generated from protobuf file "runme/agent/v1/blocks.proto" (package "runme.agent.v1", syntax proto3)
// tslint:disable
// @ts-nocheck
/* eslint-disable */
// @generated by protobuf-ts 2.11.1 with parameter output_javascript,optimize_code_size,long_type_string,add_pb_suffix,ts_nocheck,eslint_disable
...
/**
 * @generated from protobuf enum runme.agent.v1.BlockKind
 */
...
/**
 * @generated from protobuf enum runme.agent.v1.BlockRole
 */
...
/**
 * @generated from protobuf enum runme.agent.v1.BlockOutputKind
 */
...
class Block$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.Block", [
            { no: 1, name: "kind", kind: "enum", T: () => ["runme.agent.v1.BlockKind", BlockKind, "BLOCK_KIND_"] },
            ...
            { no: 9, name: "role", kind: "enum", T: () => ["runme.agent.v1.BlockRole", BlockRole, "BLOCK_ROLE_"] },
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* runme.agent.v1.BlockKind kind */ 1:
                ...
                case /* map<string, string> metadata */ 8:
                    ...
                    break;
                case /* runme.agent.v1.BlockRole role */ 9:
                    message.role = reader.int32();
                    break;
                case /* repeated runme.agent.v1.FileSearchResult file_search_results */ 10:
                    message.fileSearchResults.push(FileSearchResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated runme.agent.v1.BlockOutput outputs */ 11:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for runme.agent.v1.Block.metadata");
            }
        }
        map[key ?? ""] = val ?? "";
    }
    internalBinaryWrite(message, writer, options) {
        /* runme.agent.v1.BlockKind kind = 1; */
        if (message.kind !== 0)
        ...
        /* runme.agent.v1.BlockRole role = 9; */
        if (message.role !== 0)
            writer.tag(9, WireType.Varint).int32(message.role);
        /* repeated runme.agent.v1.FileSearchResult file_search_results = 10; */
        ...
        /* repeated runme.agent.v1.BlockOutput outputs = 11; */
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.Block
 */
export const Block = new Block$Type();
// @generated message type with reflection information, may provide speed optimized methods
class BlockOutput$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.BlockOutput", [
            { no: 1, name: "items", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => BlockOutputItem },
            { no: 2, name: "kind", kind: "enum", T: () => ["runme.agent.v1.BlockOutputKind", BlockOutputKind, "BLOCK_OUTPUT_KIND_"] }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated runme.agent.v1.BlockOutputItem items */ 1:
                    message.items.push(BlockOutputItem.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* runme.agent.v1.BlockOutputKind kind */ 2:
                    message.kind = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.BlockOutput
 */
export const BlockOutput = new BlockOutput$Type();
// @generated message type with reflection information, may provide speed optimized methods
class BlockOutputItem$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.BlockOutputItem", [
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.BlockOutputItem
 */
export const BlockOutputItem = new BlockOutputItem$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GenerateRequest$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.GenerateRequest", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated runme.agent.v1.Block blocks */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* repeated runme.agent.v1.Block blocks = 1; */
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.GenerateRequest
 */
export const GenerateRequest = new GenerateRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GenerateResponse$Type extends MessageType {
    constructor() {
        super("runme.agent.v1.GenerateResponse", [
            { no: 1, name: "blocks", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Block },
...
/**
 * @generated MessageType for protobuf message runme.agent.v1.GenerateResponse
 */
export const GenerateResponse = new GenerateResponse$Type();
/**
 * @generated ServiceType for protobuf service runme.agent.v1.BlocksService
 */
export const BlocksService = new ServiceType("runme.agent.v1.BlocksService", [
