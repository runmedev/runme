...
type MonitorEnvStoreRequest struct {
	state          protoimpl.MessageState                 `protogen:"open.v1"`
	Session        *Session                               `protobuf:"bytes,1,opt,name=session,proto3" json:"session,omitempty"`
	SnapshotPolicy *MonitorEnvStoreRequest_SnapshotPolicy `protobuf:"bytes,2,opt,name=snapshot_policy,json=snapshotPolicy,proto3" json:"snapshot_policy,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *MonitorEnvStoreRequest) GetSnapshotPolicy() *MonitorEnvStoreRequest_SnapshotPolicy {
	if x != nil {
...
type MonitorEnvStoreRequest_SnapshotPolicy struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Reveal        bool                   `protobuf:"varint,1,opt,name=reveal,proto3" json:"reveal,omitempty"`
	Insecure      bool                   `protobuf:"varint,2,opt,name=insecure,proto3" json:"insecure,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *MonitorEnvStoreRequest_SnapshotPolicy) Reset() {
	*x = MonitorEnvStoreRequest_SnapshotPolicy{}
	mi := &file_runme_runner_v2_runner_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MonitorEnvStoreRequest_SnapshotPolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MonitorEnvStoreRequest_SnapshotPolicy) ProtoMessage() {}

func (x *MonitorEnvStoreRequest_SnapshotPolicy) ProtoReflect() protoreflect.Message {
	mi := &file_runme_runner_v2_runner_proto_msgTypes[27]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MonitorEnvStoreRequest_SnapshotPolicy.ProtoReflect.Descriptor instead.
func (*MonitorEnvStoreRequest_SnapshotPolicy) Descriptor() ([]byte, []int) {
	return file_runme_runner_v2_runner_proto_rawDescGZIP(), []int{18, 0}
}

func (x *MonitorEnvStoreRequest_SnapshotPolicy) GetReveal() bool {
	if x != nil {
		return x.Reveal
	}
	return false
...
func (x *MonitorEnvStoreRequest_SnapshotPolicy) GetInsecure() bool {
	if x != nil {
		return x.Insecure
	}
	return false
...
func (x *MonitorEnvStoreResponseSnapshot_Error) Reset() {
	*x = MonitorEnvStoreResponseSnapshot_Error{}
	mi := &file_runme_runner_v2_runner_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_runme_runner_v2_runner_proto_rawDesc = "" +
	...
	"\x0eResolveProgram\x12&.runme.runner.v2.ResolveProgramRequest\x1a'.runme.runner.v2.ResolveProgramResponse\"\x00BHZFgithub.com/runmedev/runme/v3/api/gen/proto/go/runme/runner/v2;runnerv2b\x06proto3"
...
var (
	file_runme_runner_v2_runner_proto_enumTypes = make([]protoimpl.EnumInfo, 9)
	file_runme_runner_v2_runner_proto_msgTypes  = make([]protoimpl.MessageInfo, 30)
	file_runme_runner_v2_runner_proto_goTypes   = []any{
		...
		(*MonitorEnvStoreRequest_SnapshotPolicy)(nil),       // 36: runme.runner.v2.MonitorEnvStoreRequest.SnapshotPolicy
		(*MonitorEnvStoreResponseSnapshot_SnapshotEnv)(nil), // 37: runme.runner.v2.MonitorEnvStoreResponseSnapshot.SnapshotEnv
		(*MonitorEnvStoreResponseSnapshot_Error)(nil),       // 38: runme.runner.v2.MonitorEnvStoreResponseSnapshot.Error
		(*ProgramConfig)(nil),                               // 39: runme.runner.v2.ProgramConfig
...
var file_runme_runner_v2_runner_proto_depIdxs = []int32{
	...
	39, // 11: runme.runner.v2.ExecuteRequest.config:type_name -> runme.runner.v2.ProgramConfig
	...
	40, // 16: runme.runner.v2.ExecuteResponse.exit_code:type_name -> google.protobuf.UInt32Value
	40, // 17: runme.runner.v2.ExecuteResponse.pid:type_name -> google.protobuf.UInt32Value
	...
	36, // 27: runme.runner.v2.MonitorEnvStoreRequest.snapshot_policy:type_name -> runme.runner.v2.MonitorEnvStoreRequest.SnapshotPolicy
	37, // 28: runme.runner.v2.MonitorEnvStoreResponseSnapshot.envs:type_name -> runme.runner.v2.MonitorEnvStoreResponseSnapshot.SnapshotEnv
	3,  // 29: runme.runner.v2.MonitorEnvStoreResponse.type:type_name -> runme.runner.v2.MonitorEnvStoreType
	28, // 30: runme.runner.v2.MonitorEnvStoreResponse.snapshot:type_name -> runme.runner.v2.MonitorEnvStoreResponseSnapshot
	0,  // 31: runme.runner.v2.CreateSessionRequest.Config.env_store_type:type_name -> runme.runner.v2.SessionEnvStoreType
	4,  // 32: runme.runner.v2.CreateSessionRequest.Config.env_store_seeding:type_name -> runme.runner.v2.CreateSessionRequest.Config.SessionEnvStoreSeeding
	7,  // 33: runme.runner.v2.ResolveProgramResponse.VarResult.status:type_name -> runme.runner.v2.ResolveProgramResponse.Status
	8,  // 34: runme.runner.v2.MonitorEnvStoreResponseSnapshot.SnapshotEnv.status:type_name -> runme.runner.v2.MonitorEnvStoreResponseSnapshot.Status
	38, // 35: runme.runner.v2.MonitorEnvStoreResponseSnapshot.SnapshotEnv.errors:type_name -> runme.runner.v2.MonitorEnvStoreResponseSnapshot.Error
	11, // 36: runme.runner.v2.RunnerService.CreateSession:input_type -> runme.runner.v2.CreateSessionRequest
	13, // 37: runme.runner.v2.RunnerService.GetSession:input_type -> runme.runner.v2.GetSessionRequest
	15, // 38: runme.runner.v2.RunnerService.ListSessions:input_type -> runme.runner.v2.ListSessionsRequest
	17, // 39: runme.runner.v2.RunnerService.UpdateSession:input_type -> runme.runner.v2.UpdateSessionRequest
	19, // 40: runme.runner.v2.RunnerService.DeleteSession:input_type -> runme.runner.v2.DeleteSessionRequest
	27, // 41: runme.runner.v2.RunnerService.MonitorEnvStore:input_type -> runme.runner.v2.MonitorEnvStoreRequest
	22, // 42: runme.runner.v2.RunnerService.Execute:input_type -> runme.runner.v2.ExecuteRequest
	25, // 43: runme.runner.v2.RunnerService.ResolveProgram:input_type -> runme.runner.v2.ResolveProgramRequest
	12, // 44: runme.runner.v2.RunnerService.CreateSession:output_type -> runme.runner.v2.CreateSessionResponse
	14, // 45: runme.runner.v2.RunnerService.GetSession:output_type -> runme.runner.v2.GetSessionResponse
	16, // 46: runme.runner.v2.RunnerService.ListSessions:output_type -> runme.runner.v2.ListSessionsResponse
	18, // 47: runme.runner.v2.RunnerService.UpdateSession:output_type -> runme.runner.v2.UpdateSessionResponse
	20, // 48: runme.runner.v2.RunnerService.DeleteSession:output_type -> runme.runner.v2.DeleteSessionResponse
	29, // 49: runme.runner.v2.RunnerService.MonitorEnvStore:output_type -> runme.runner.v2.MonitorEnvStoreResponse
	23, // 50: runme.runner.v2.RunnerService.Execute:output_type -> runme.runner.v2.ExecuteResponse
	26, // 51: runme.runner.v2.RunnerService.ResolveProgram:output_type -> runme.runner.v2.ResolveProgramResponse
