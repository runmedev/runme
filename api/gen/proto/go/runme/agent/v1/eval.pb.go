...
// 	protoc        (unknown)
// source: runme/agent/v1/eval.proto
...
func (Assertion_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_runme_agent_v1_eval_proto_enumTypes[0].Descriptor()
}

func (Assertion_Type) Type() protoreflect.EnumType {
	return &file_runme_agent_v1_eval_proto_enumTypes[0]
}
...
func (Assertion_Type) EnumDescriptor() ([]byte, []int) {
	return file_runme_agent_v1_eval_proto_rawDescGZIP(), []int{0, 0}
}
...
func (Assertion_Result) Descriptor() protoreflect.EnumDescriptor {
	return file_runme_agent_v1_eval_proto_enumTypes[1].Descriptor()
}

func (Assertion_Result) Type() protoreflect.EnumType {
	return &file_runme_agent_v1_eval_proto_enumTypes[1]
}
...
func (Assertion_Result) EnumDescriptor() ([]byte, []int) {
	return file_runme_agent_v1_eval_proto_rawDescGZIP(), []int{0, 1}
}
...
type Assertion struct {
	...
	Type   Assertion_Type         `protobuf:"varint,2,opt,name=type,proto3,enum=runme.agent.v1.Assertion_Type" json:"type,omitempty"`
	Result Assertion_Result       `protobuf:"varint,3,opt,name=result,proto3,enum=runme.agent.v1.Assertion_Result" json:"result,omitempty"`
...
func (x *Assertion) Reset() {
	*x = Assertion{}
	mi := &file_runme_agent_v1_eval_proto_msgTypes[0]
...
func (*Assertion) Descriptor() ([]byte, []int) {
	return file_runme_agent_v1_eval_proto_rawDescGZIP(), []int{0}
}
...
func (x *EvalSample) Reset() {
	*x = EvalSample{}
	mi := &file_runme_agent_v1_eval_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EvalSample) Descriptor() ([]byte, []int) {
	return file_runme_agent_v1_eval_proto_rawDescGZIP(), []int{1}
}
...
func (x *EvalDataset) Reset() {
	*x = EvalDataset{}
	mi := &file_runme_agent_v1_eval_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EvalDataset) Descriptor() ([]byte, []int) {
	return file_runme_agent_v1_eval_proto_rawDescGZIP(), []int{2}
}
...
func (x *ObjectMeta) Reset() {
	*x = ObjectMeta{}
	mi := &file_runme_agent_v1_eval_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ObjectMeta) Descriptor() ([]byte, []int) {
	return file_runme_agent_v1_eval_proto_rawDescGZIP(), []int{3}
}
...
func (x *ExperimentSpec) Reset() {
	*x = ExperimentSpec{}
	mi := &file_runme_agent_v1_eval_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExperimentSpec) Descriptor() ([]byte, []int) {
	return file_runme_agent_v1_eval_proto_rawDescGZIP(), []int{4}
}
...
func (x *Experiment) Reset() {
	*x = Experiment{}
	mi := &file_runme_agent_v1_eval_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Experiment) Descriptor() ([]byte, []int) {
	return file_runme_agent_v1_eval_proto_rawDescGZIP(), []int{5}
}
...
func (x *Assertion_ShellRequiredFlag) Reset() {
	*x = Assertion_ShellRequiredFlag{}
	mi := &file_runme_agent_v1_eval_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Assertion_ToolInvocation) Reset() {
	*x = Assertion_ToolInvocation{}
	mi := &file_runme_agent_v1_eval_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Assertion_FileRetrieval) Reset() {
	*x = Assertion_FileRetrieval{}
	mi := &file_runme_agent_v1_eval_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Assertion_FileRetrieval) Descriptor() ([]byte, []int) {
	return file_runme_agent_v1_eval_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *Assertion_LLMJudge) Reset() {
	*x = Assertion_LLMJudge{}
	mi := &file_runme_agent_v1_eval_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Assertion_LLMJudge) Descriptor() ([]byte, []int) {
	return file_runme_agent_v1_eval_proto_rawDescGZIP(), []int{0, 3}
}
...
func (x *Assertion_CodeblockRegex) Reset() {
	*x = Assertion_CodeblockRegex{}
	mi := &file_runme_agent_v1_eval_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Assertion_CodeblockRegex) Descriptor() ([]byte, []int) {
	return file_runme_agent_v1_eval_proto_rawDescGZIP(), []int{0, 4}
}
...
var File_runme_agent_v1_eval_proto protoreflect.FileDescriptor

const file_runme_agent_v1_eval_proto_rawDesc = "" +
	"\n" +
	"\x19runme/agent/v1/eval.proto\x12\x0erunme.agent.v1\x1a\x1bbuf/validate/validate.proto\"\xbc\t\n" +
	"\tAssertion\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12:\n" +
	"\x04type\x18\x02 \x01(\x0e2\x1e.runme.agent.v1.Assertion.TypeB\x06\xbaH\x03\xc8\x01\x01R\x04type\x128\n" +
	"\x06result\x18\x03 \x01(\x0e2 .runme.agent.v1.Assertion.ResultR\x06result\x12]\n" +
	"\x13shell_required_flag\x18\x04 \x01(\v2+.runme.agent.v1.Assertion.ShellRequiredFlagH\x00R\x11shellRequiredFlag\x12S\n" +
	"\x0ftool_invocation\x18\x05 \x01(\v2(.runme.agent.v1.Assertion.ToolInvocationH\x00R\x0etoolInvocation\x12P\n" +
	"\x0efile_retrieval\x18\x06 \x01(\v2'.runme.agent.v1.Assertion.FileRetrievalH\x00R\rfileRetrieval\x12A\n" +
	"\tllm_judge\x18\a \x01(\v2\".runme.agent.v1.Assertion.LLMJudgeH\x00R\bllmJudge\x12S\n" +
	"\x0fcodeblock_regex\x18\b \x01(\v2(.runme.agent.v1.Assertion.CodeblockRegexH\x00R\x0ecodeblockRegex\x12%\n" +
	...
	"\apayload\x12\x05\xbaH\x02\b\x01\"\xdf\x01\n" +
	"\n" +
	"EvalSample\x12\x1e\n" +
	"\x04kind\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04kind\x12>\n" +
	"\bmetadata\x18\x02 \x01(\v2\x1a.runme.agent.v1.ObjectMetaB\x06\xbaH\x03\xc8\x01\x01R\bmetadata\x12)\n" +
	"\n" +
	"input_text\x18\x03 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\tinputText\x12F\n" +
	"\n" +
	"assertions\x18\x04 \x03(\v2\x19.runme.agent.v1.AssertionB\v\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01R\n" +
	"assertions\"C\n" +
	"\vEvalDataset\x124\n" +
	"\asamples\x18\x01 \x03(\v2\x1a.runme.agent.v1.EvalSampleR\asamples\",\n" +
	"\n" +
	"ObjectMeta\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	...
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x11inferenceEndpoint\"\xd5\x01\n" +
	"\n" +
	"Experiment\x12+\n" +
	...
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04kind\x12>\n" +
	"\bmetadata\x18\x03 \x01(\v2\x1a.runme.agent.v1.ObjectMetaB\x06\xbaH\x03\xc8\x01\x01R\bmetadata\x12:\n" +
	"\x04spec\x18\x04 \x01(\v2\x1e.runme.agent.v1.ExperimentSpecB\x06\xbaH\x03\xc8\x01\x01R\x04specBFZDgithub.com/runmedev/runme/v3/api/gen/proto/go/runme/agent/v1;agentv1b\x06proto3"

var (
	file_runme_agent_v1_eval_proto_rawDescOnce sync.Once
	file_runme_agent_v1_eval_proto_rawDescData []byte
)

func file_runme_agent_v1_eval_proto_rawDescGZIP() []byte {
	file_runme_agent_v1_eval_proto_rawDescOnce.Do(func() {
		file_runme_agent_v1_eval_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runme_agent_v1_eval_proto_rawDesc), len(file_runme_agent_v1_eval_proto_rawDesc)))
	})
	return file_runme_agent_v1_eval_proto_rawDescData
}

var file_runme_agent_v1_eval_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_runme_agent_v1_eval_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_runme_agent_v1_eval_proto_goTypes = []any{
	(Assertion_Type)(0),                 // 0: runme.agent.v1.Assertion.Type
	(Assertion_Result)(0),               // 1: runme.agent.v1.Assertion.Result
	(*Assertion)(nil),                   // 2: runme.agent.v1.Assertion
	(*EvalSample)(nil),                  // 3: runme.agent.v1.EvalSample
	(*EvalDataset)(nil),                 // 4: runme.agent.v1.EvalDataset
	(*ObjectMeta)(nil),                  // 5: runme.agent.v1.ObjectMeta
	(*ExperimentSpec)(nil),              // 6: runme.agent.v1.ExperimentSpec
	(*Experiment)(nil),                  // 7: runme.agent.v1.Experiment
	(*Assertion_ShellRequiredFlag)(nil), // 8: runme.agent.v1.Assertion.ShellRequiredFlag
	(*Assertion_ToolInvocation)(nil),    // 9: runme.agent.v1.Assertion.ToolInvocation
	(*Assertion_FileRetrieval)(nil),     // 10: runme.agent.v1.Assertion.FileRetrieval
	(*Assertion_LLMJudge)(nil),          // 11: runme.agent.v1.Assertion.LLMJudge
	(*Assertion_CodeblockRegex)(nil),    // 12: runme.agent.v1.Assertion.CodeblockRegex
}
var file_runme_agent_v1_eval_proto_depIdxs = []int32{
	0,  // 0: runme.agent.v1.Assertion.type:type_name -> runme.agent.v1.Assertion.Type
	1,  // 1: runme.agent.v1.Assertion.result:type_name -> runme.agent.v1.Assertion.Result
	8,  // 2: runme.agent.v1.Assertion.shell_required_flag:type_name -> runme.agent.v1.Assertion.ShellRequiredFlag
	9,  // 3: runme.agent.v1.Assertion.tool_invocation:type_name -> runme.agent.v1.Assertion.ToolInvocation
	10, // 4: runme.agent.v1.Assertion.file_retrieval:type_name -> runme.agent.v1.Assertion.FileRetrieval
	11, // 5: runme.agent.v1.Assertion.llm_judge:type_name -> runme.agent.v1.Assertion.LLMJudge
	12, // 6: runme.agent.v1.Assertion.codeblock_regex:type_name -> runme.agent.v1.Assertion.CodeblockRegex
	5,  // 7: runme.agent.v1.EvalSample.metadata:type_name -> runme.agent.v1.ObjectMeta
	2,  // 8: runme.agent.v1.EvalSample.assertions:type_name -> runme.agent.v1.Assertion
	3,  // 9: runme.agent.v1.EvalDataset.samples:type_name -> runme.agent.v1.EvalSample
	5,  // 10: runme.agent.v1.Experiment.metadata:type_name -> runme.agent.v1.ObjectMeta
	6,  // 11: runme.agent.v1.Experiment.spec:type_name -> runme.agent.v1.ExperimentSpec
...
func init() { file_runme_agent_v1_eval_proto_init() }
func file_runme_agent_v1_eval_proto_init() {
	if File_runme_agent_v1_eval_proto != nil {
		return
	}
	file_runme_agent_v1_eval_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runme_agent_v1_eval_proto_rawDesc), len(file_runme_agent_v1_eval_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runme_agent_v1_eval_proto_goTypes,
		DependencyIndexes: file_runme_agent_v1_eval_proto_depIdxs,
		EnumInfos:         file_runme_agent_v1_eval_proto_enumTypes,
		MessageInfos:      file_runme_agent_v1_eval_proto_msgTypes,
	}.Build()
	File_runme_agent_v1_eval_proto = out.File
	file_runme_agent_v1_eval_proto_goTypes = nil
	file_runme_agent_v1_eval_proto_depIdxs = nil
}
