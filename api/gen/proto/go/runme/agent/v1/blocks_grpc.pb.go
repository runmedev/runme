...
const (
	BlocksService_Generate_FullMethodName = "/runme.agent.v1.BlocksService/Generate"
)
...
var BlocksService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "runme.agent.v1.BlocksService",
	...
	Metadata: "runme/agent/v1/blocks.proto",
}
