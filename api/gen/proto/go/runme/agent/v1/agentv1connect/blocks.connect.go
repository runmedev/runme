...
import (
	...
	v1 "github.com/runmedev/runme/v3/api/gen/proto/go/runme/agent/v1"
)
...
const (
	...
	BlocksServiceName = "runme.agent.v1.BlocksService"
)
...
const (
	...
	BlocksServiceGenerateProcedure = "/runme.agent.v1.BlocksService/Generate"
)

// BlocksServiceClient is a client for the runme.agent.v1.BlocksService service.
...
// NewBlocksServiceClient constructs a client for the runme.agent.v1.BlocksService service. By
...
func NewBlocksServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) BlocksServiceClient {
	...
	blocksServiceMethods := v1.File_runme_agent_v1_blocks_proto.Services().ByName("BlocksService").Methods()
...
// Generate calls runme.agent.v1.BlocksService.Generate.
...
// BlocksServiceHandler is an implementation of the runme.agent.v1.BlocksService service.
...
func NewBlocksServiceHandler(svc BlocksServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/runme.agent.v1.BlocksService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedBlocksServiceHandler) Generate(context.Context, *connect.Request[v1.GenerateRequest], *connect.ServerStream[v1.GenerateResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("runme.agent.v1.BlocksService.Generate is not implemented"))
}
