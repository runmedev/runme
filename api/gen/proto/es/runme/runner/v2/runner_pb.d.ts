...
import type { ProgramConfig } from "./config_pb.js";
 ...
 */
export declare const CreateSessionRequest_ConfigSchema: GenMessage<CreateSessionRequest_Config>;
 ...
 */
export declare const CreateSessionRequest_Config_SessionEnvStoreSeedingSchema: GenEnum<CreateSessionRequest_Config_SessionEnvStoreSeeding>;
 ...
 */
export declare const WinsizeSchema: GenMessage<Winsize>;
 ...
 */
export declare const ResolveProgramCommandListSchema: GenMessage<ResolveProgramCommandList>;
 ...
 */
export declare const ResolveProgramRequestSchema: GenMessage<ResolveProgramRequest>;
 ...
 */
export declare const ResolveProgramRequest_ModeSchema: GenEnum<ResolveProgramRequest_Mode>;
 ...
 */
export declare const ResolveProgramRequest_RetentionSchema: GenEnum<ResolveProgramRequest_Retention>;
 ...
 */
export declare const ResolveProgramResponseSchema: GenMessage<ResolveProgramResponse>;
 ...
 */
export declare const ResolveProgramResponse_VarResultSchema: GenMessage<ResolveProgramResponse_VarResult>;
 ...
 */
export declare const ResolveProgramResponse_StatusSchema: GenEnum<ResolveProgramResponse_Status>;
 ...
 */
export declare const MonitorEnvStoreRequestSchema: GenMessage<MonitorEnvStoreRequest>;
 ...
 */
export declare const MonitorEnvStoreResponseSnapshotSchema: GenMessage<MonitorEnvStoreResponseSnapshot>;
 ...
 */
export declare const MonitorEnvStoreResponseSnapshot_SnapshotEnvSchema: GenMessage<MonitorEnvStoreResponseSnapshot_SnapshotEnv>;
 ...
 */
export declare const MonitorEnvStoreResponseSnapshot_ErrorSchema: GenMessage<MonitorEnvStoreResponseSnapshot_Error>;
 ...
 */
export declare const MonitorEnvStoreResponseSnapshot_StatusSchema: GenEnum<MonitorEnvStoreResponseSnapshot_Status>;
 ...
 */
export declare const MonitorEnvStoreResponseSchema: GenMessage<MonitorEnvStoreResponse>;
 ...
 */
export declare const SessionEnvStoreTypeSchema: GenEnum<SessionEnvStoreType>;
 ...
 */
export declare const ExecuteStopSchema: GenEnum<ExecuteStop>;
 ...
 */
export declare const SessionStrategySchema: GenEnum<SessionStrategy>;
 ...
 */
export declare const MonitorEnvStoreTypeSchema: GenEnum<MonitorEnvStoreType>;
