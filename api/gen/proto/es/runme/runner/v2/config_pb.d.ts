 ...
 */
export declare const ProgramConfigSchema: GenMessage<ProgramConfig>;
 ...
 */
export declare const ProgramConfig_CommandListSchema: GenMessage<ProgramConfig_CommandList>;
