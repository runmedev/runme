 ...
 */
export declare const file_runme_agent_v1_credentials: GenFile;

/**
 * @generated from message runme.agent.v1.OAuthToken
 */
export declare type OAuthToken = Message<"runme.agent.v1.OAuthToken"> & {
  /**
   * The OAuth token.
   *
