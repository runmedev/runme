 ...
 */
export declare const file_runme_agent_v1_blocks: GenFile;

/**
 * Block represents the data in an element in the UI.
 *
 * @generated from message runme.agent.v1.Block
 */
export declare type Block = Message<"runme.agent.v1.Block"> & {
  /**
   * BlockKind is an enum indicating what type of block it is e.g text or output
   *
   * @generated from field: runme.agent.v1.BlockKind kind = 1;
   */
  kind: BlockKind;
  ...
  /**
   * @generated from field: runme.agent.v1.BlockRole role = 9;
   */
  role: BlockRole;

  /**
   * @generated from field: repeated runme.agent.v1.FileSearchResult file_search_results = 10;
   */
  fileSearchResults: FileSearchResult[];

  /**
   * @generated from field: repeated runme.agent.v1.BlockOutput outputs = 11;
   */
  outputs: BlockOutput[];
 ...
 *
 * @generated from message runme.agent.v1.BlockOutput
 */
export declare type BlockOutput = Message<"runme.agent.v1.BlockOutput"> & {
  /**
   * items is the output items. Each item is the different representation of the same output data
   *
   * @generated from field: repeated runme.agent.v1.BlockOutputItem items = 1;
   */
  items: BlockOutputItem[];

  /**
   * @generated from field: runme.agent.v1.BlockOutputKind kind = 2;
   */
 ...
 *
 * @generated from message runme.agent.v1.BlockOutputItem
 */
export declare type BlockOutputItem = Message<"runme.agent.v1.BlockOutputItem"> & {
  /**
...
/**
 * @generated from message runme.agent.v1.GenerateRequest
 */
export declare type GenerateRequest = Message<"runme.agent.v1.GenerateRequest"> & {
  /**
   * @generated from field: repeated runme.agent.v1.Block blocks = 1;
   */
  blocks: Block[];
...
/**
 * @generated from message runme.agent.v1.GenerateResponse
 */
export declare type GenerateResponse = Message<"runme.agent.v1.GenerateResponse"> & {
  /**
   * @generated from field: repeated runme.agent.v1.Block blocks = 1;
   */
  blocks: Block[];
...
export declare const BlocksService: GenService<{
   ...
   *
   * @generated from rpc runme.agent.v1.BlocksService.Generate
   */
  generate: {
