 ...
 */
export declare const DirectoryProjectOptionsSchema: GenMessage<DirectoryProjectOptions, {jsonType: DirectoryProjectOptionsJson}>;
 ...
 */
export declare const FileProjectOptionsSchema: GenMessage<FileProjectOptions, {jsonType: FileProjectOptionsJson}>;
 ...
 */
export declare const LoadRequestSchema: GenMessage<LoadRequest, {jsonType: LoadRequestJson}>;
 ...
 */
export declare const LoadEventStartedWalkSchema: GenMessage<LoadEventStartedWalk, {jsonType: LoadEventStartedWalkJson}>;
 ...
 */
export declare const LoadEventFoundDirSchema: GenMessage<LoadEventFoundDir, {jsonType: LoadEventFoundDirJson}>;
 ...
 */
export declare const LoadEventFoundFileSchema: GenMessage<LoadEventFoundFile, {jsonType: LoadEventFoundFileJson}>;
 ...
 */
export declare const LoadEventFinishedWalkSchema: GenMessage<LoadEventFinishedWalk, {jsonType: LoadEventFinishedWalkJson}>;
 ...
 */
export declare const LoadEventStartedParsingDocSchema: GenMessage<LoadEventStartedParsingDoc, {jsonType: LoadEventStartedParsingDocJson}>;
 ...
 */
export declare const LoadEventFinishedParsingDocSchema: GenMessage<LoadEventFinishedParsingDoc, {jsonType: LoadEventFinishedParsingDocJson}>;
 ...
 */
export declare const LoadEventFoundTaskSchema: GenMessage<LoadEventFoundTask, {jsonType: LoadEventFoundTaskJson}>;
 ...
 */
export declare const LoadEventErrorSchema: GenMessage<LoadEventError, {jsonType: LoadEventErrorJson}>;
 ...
 */
export declare const LoadResponseSchema: GenMessage<LoadResponse, {jsonType: LoadResponseJson}>;
