 ...
 */
export declare const AssertionSchema: GenMessage<Assertion, {jsonType: AssertionJson}>;
 ...
 */
export declare const Assertion_ShellRequiredFlagSchema: GenMessage<Assertion_ShellRequiredFlag, {jsonType: Assertion_ShellRequiredFlagJson}>;
 ...
 */
export declare const Assertion_ToolInvocationSchema: GenMessage<Assertion_ToolInvocation, {jsonType: Assertion_ToolInvocationJson}>;
 ...
 */
export declare const Assertion_FileRetrievalSchema: GenMessage<Assertion_FileRetrieval, {jsonType: Assertion_FileRetrievalJson}>;
 ...
 */
export declare const Assertion_LLMJudgeSchema: GenMessage<Assertion_LLMJudge, {jsonType: Assertion_LLMJudgeJson}>;
 ...
 */
export declare const Assertion_CodeblockRegexSchema: GenMessage<Assertion_CodeblockRegex, {jsonType: Assertion_CodeblockRegexJson}>;
 ...
 * @generated from enum agent.v1.Assertion.Type
 */
export declare type Assertion_TypeJson = "TYPE_UNSPECIFIED" | "TYPE_SHELL_REQUIRED_FLAG" | "TYPE_TOOL_INVOKED" | "TYPE_FILE_RETRIEVED" | "TYPE_LLM_JUDGE" | "TYPE_CODEBLOCK_REGEX";
 ...
 * @generated from enum agent.v1.Assertion.Result
 */
export declare type Assertion_ResultJson = "RESULT_UNSPECIFIED" | "RESULT_TRUE" | "RESULT_FALSE" | "RESULT_SKIPPED";
 ...
 */
export declare const EvalSampleSchema: GenMessage<EvalSample, {jsonType: EvalSampleJson}>;
 ...
 */
export declare const EvalDatasetSchema: GenMessage<EvalDataset, {jsonType: EvalDatasetJson}>;
 ...
 */
export declare const ObjectMetaSchema: GenMessage<ObjectMeta, {jsonType: ObjectMetaJson}>;
 ...
 */
export declare const ExperimentSpecSchema: GenMessage<ExperimentSpec, {jsonType: ExperimentSpecJson}>;
