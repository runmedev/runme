...
require (
	...
	github.com/redpanda-data/protoc-gen-go-mcp v0.0.0-20260610124158-78ea28e8c1aa
...
require (
	...
	github.com/redpanda-data/common-go/api v0.0.0-20260611173554-439d49584fdd // indirect
