...
require (
	...
	github.com/redpanda-data/protoc-gen-go-mcp v0.0.0-20260529161527-954bf16822c5
...
require (
	...
	github.com/redpanda-data/common-go/api v0.0.0-20260527140506-24305d074a5a // indirect
